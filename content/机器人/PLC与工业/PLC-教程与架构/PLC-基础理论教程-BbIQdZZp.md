---
title: PLC 基础理论教程
url: https://my.feishu.cn/docx/BbIQdZZpLouY73xEndtc5B0knbd
quality: raw
attachments:
- file: attachments/BbIQdZZpLouY73xEndtc5B0knbd/file_009.mp4
  title: file_009.mp4
- file: attachments/BbIQdZZpLouY73xEndtc5B0knbd/file_010.mp4
  title: file_010.mp4
- file: attachments/BbIQdZZpLouY73xEndtc5B0knbd/file_011.pdf
  title: file_011.pdf
- file: attachments/BbIQdZZpLouY73xEndtc5B0knbd/file_012.pdf
  title: file_012.pdf
fetch_source: feishu:cli
fetched_at: 2026-06-28 04:55:50+00:00
feishu_formatted_at: 2026-06-28 07:15:37+00:00
urls_repaired_at: 2026-06-28 04:55:50+00:00
wikilinks_unbulleted_at: 2026-06-28 05:48:28+00:00
sheets_expanded_at: 2026-06-29 10:25:08+00:00
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_007.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_009.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_017.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_018.png)
根据不同的功能，功能块可以有任意数量的输入和输出。你可以将一个功能块的输出连接到另一个功能块的输入，从而构建出完整的功能块图（Function Block Diagram）。

![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_019.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_020.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_021.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_022.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_025.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_027.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_028.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_029.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_031.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_037.png)
...
[file_009.mp4](attachments/BbIQdZZpLouY73xEndtc5B0knbd/file_009.mp4)
...
##### CFC 文件
 ...
 工程工具软件是一个用图形化创建自动化程序的设计工具。CFC 图的主要元素是一些能够在图上自由排列的模块（功能块, 用户自定义模块和复合模块）和将一个输出和一个或多个输入连接的连线。

### 模块的使用

![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_041.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_043.png)
连接两个功能块，先选择一个功能块的某个输出管脚（输入管脚），再选择另一个功能块的某个输入管脚（输出管脚），若两个管脚类型相同或兼容，则可完成两个管脚之间的连线。工程工具软件支持多线连接。如图 所示：

![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_044.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_048.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_053.png)
...
- 进入复合模块：
   ...
   ![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_056.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_059.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_062.png)
...
![image](attachments/BbIQdZZpLouY73xEndtc5B0knbd/img_063.png)
...
- [file_011.pdf](attachments/BbIQdZZpLouY73xEndtc5B0knbd/file_011.pdf)
- [file_012.pdf](attachments/BbIQdZZpLouY73xEndtc5B0knbd/file_012.pdf)
...
[[术语定义-GuiRdHfM|术语定义]]
[[电气控制与国产化PLC应用技术-UWs7d7b7|电气控制与国产化PLC应用技术]] — _PLC / 工业_
...
- [file_010.mp4](attachments/BbIQdZZpLouY73xEndtc5B0knbd/file_010.mp4)
